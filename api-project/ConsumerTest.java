...
public class ConsumerTest {
    ...
    //create the body
        DslPart requestResponseBody = new PactDslJsonBody()
                .numberType("id",1)
                .stringType("firstName",    "Vandana")
                .stringType("lastName","T")
                .stringType("email","Vandana.T@ibm.com");
    ...
    public void consumerTest() {
        ...
        reqBody.put("id",121);
        reqBody.put("firstName","Vandana");
        reqBody.put("lastName","T");
        reqBody.put("email","Vandana.T@ibm.com");
